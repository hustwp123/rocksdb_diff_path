...
namespace rocksdb {
    namespace succinct {
        namespace util {
            ...
            class line_iterator
                    : public boost::iterator_facade<line_iterator, std::string const, boost::forward_traversal_tag
                    > {
            public:
                line_iterator()
                        : m_file(0) {}
            ...
            class buffer_line_iterator
                    : public boost::iterator_facade<buffer_line_iterator, std::string const, boost::forward_traversal_tag
                    > {
            public:
                buffer_line_iterator()
                        : m_buffer(0), m_end(0), m_cur_pos(0) {}
